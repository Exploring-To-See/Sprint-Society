...
//
// Ported from the Ishan-AI-Coach lab (the `ai-coach-assets` branch preserves the
// Python source, the RAG corpus, guardrails, TTS, and the eval harness). The engine
