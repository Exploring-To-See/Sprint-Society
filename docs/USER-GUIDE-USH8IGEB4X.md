...
## Kendu — In-App Currency

Kendu is Sprint Society's real currency. **1 Kendu = 1 km of running.** Earn it by running, improving, and showing up consistently. Spend it in the app (create communities, host events, challenge friends) or redeem brand offers at the marketplace.
...
|--------|-------------|
| Per km run | **1 Kendu** |
| Run assigned by AI coach | 1.5x multiplier |
| Beat a personal best (pace or distance) | +5 |
| Complete a coach workout | +3 |
| Finish a full training plan | +20 |
| 4+ runs in a single week | +5 |
| Every 7-day streak milestone | +10 |
| Complete a community event | +8 |

**Daily cap:** 50 Kendu per day.
**Kendu never expires.** Your lifetime total drives your level.

### How to Spend Kendu

| Action | Cost | What You Get |
|--------|------|--------------|
| Create a Community | 1000 | Request reviewed by admin; charged on approval (+ 20/month upkeep) |
| Host an Event | 75 | Create an event others can join |
| 1v1 Challenge | 5-50 stake | Challenge a friend, winner takes pot |
| Priority RSVP | 15 | Guaranteed spot in limited events |
| Gift Kendu | 3+ (15% fee) | Send Kendu to a friend |
| Premium Card Skin | 40 | Unlock exclusive share card template |
| Boost Post | 10 | Pin your post to top of community for 24h |
| Group Challenge | 50 | Create a challenge for multiple people |
| AI Deep Dive | 30 | Extended AI coach session beyond daily limit |
| Sponsor Leaderboard | 500 | Your name on community board for 7 days |

### 1v1 Challenges (/challenges)

- Challenge any runner to a competition (distance, pace, streak, or run count)
- Both players stake 5-50 Kendu each
- Winner takes the pot minus 20% platform fee (burned permanently)
- If no one meets the target, both get 80% back
- Declined challenges refund the challenger immediately

### Creating a Community

1. Go to Communities → "Request a Community"
2. Fill in: name, purpose, category, your name, contact
3. Submit your request (free — no Kendu charged yet)
4. Admin reviews your request and approves or rejects
5. If approved: **1000 Kendu** is charged from your balance and the community goes live
6. You need at least 1000 Kendu in your balance at the time of approval

### Community Upkeep

Communities cost 20 Kendu/month to keep alive. If you can't pay when it's due, your community goes dormant (hidden from browse, but members can still see it). Pay to reactivate anytime.

### Rewards Marketplace (/rewards)

- Access from your **Profile** page (tap the Kendu widget)
- Browse brand offers with their Kendu cost and real-world value
- Tap **Redeem** to exchange Kendu for a coupon code
- You need at least **5 completed runs** before you can redeem
- Max **1 redemption per offer** per user

### Kendu Widget (Profile)
...
- Active subscriptions (community upkeep dues)

### Post-Run Kendu Modal

After every run, an animated popup shows:
- Total Kendu earned that run
- Breakdown (base km + coach bonus + PB bonus + streak milestone)
- Updated balance and streak status

---

## XP & Leveling

- XP has been replaced by **Kendu** as the primary progression currency
- Your level is calculated from lifetime Kendu earned (exponential curve)
- Your level is displayed on your profile and Kendu widget
- Compete on the **Leaderboard** (top earners by lifetime Kendu)
